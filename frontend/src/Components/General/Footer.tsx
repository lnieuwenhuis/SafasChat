...
const Footer: React.FC = () => {
    return (
        <footer className="bg-slate-900 border-t border-purple-800/30 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex space-x-6">
                ...
                <a href="https://github.com/lnieuwenhuis/SafasChat" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors duration-200">GitHub</a>
            </div>
            </div>
            <div className="mt-8 pt-8 border-t border-purple-800/30 text-center text-slate-400">
